...
=======
### random effects
>>>>>>> 09ad8d0727ab55b86c468214cee902a95440403c
...
How to calcualte? 
1. Intercept $$ \gamma_{00} \pm  1.96  *  U_{0j}  $$
```{r}
...
2. Slope $$ \gamma_{10} \pm  1.96  *  U_{1j}  $$
```{r}
...
Deviance comapres the two LLs. Current model and a saturated model (that fits data perfectly). 
...
1. same data
2. nested models (think of constraining to zero)
...
### AIC and BIC
<<<<<<< HEAD
AIC (Akaike’s Information Criterion) and the BIC (Bayesian Information Criterion) where “smaller is better.” As with the other types, these may give you wonky findings depending on some factors as they are related to LLs
=======
...
Can easily do a lot of models simultaneously. You do not need to use for loops. 
=======
